...
#ifdef EE_AS_IOC__
#include "`$INSTANCE_NAME`_ee_as_ioc.h"
/*                                 WARNING
   ...
   project root. */
#include "`$INSTANCE_NAME`_ioc_common.h"
#endif /* EE_AS_IOC__ */

#ifdef EE_AS_SCHEDULETABLES__
#include "`$INSTANCE_NAME`_ee_as_schedule_tables.h"
...
/* SEM */
#ifdef __SEM__
#include "`$INSTANCE_NAME`_ee_sem.h"
#endif

/* ALARMS */
#ifdef __ALARMS__
#include "`$INSTANCE_NAME`_ee_alarms.h"
#endif

/* RN */
#if (defined(__RN__)) || (defined(EE_AS_RPC__))
#include "`$INSTANCE_NAME`_ee_rn.h"
...
#ifdef __ASSERT__
#include "`$INSTANCE_NAME`_ee_assert.h"
#endif /* __ASSERT__ */
