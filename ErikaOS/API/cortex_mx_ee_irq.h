...
#include "`$INSTANCE_NAME`_cortex_mx_ee_cpu.h"
#include "`$INSTANCE_NAME`_cortex_mx_ee_irq_cng_cont.h"
#include "`$INSTANCE_NAME`_cortex_mx_ee_context.h"
#include "`$INSTANCE_NAME`_common_ee_irqstub.h"
