...
#ifdef __GNU__
#include "`$INSTANCE_NAME`_common_ee_compiler_gcc.h"
#endif
...
#include "`$INSTANCE_NAME`_common_ee_types.h"
...
#include "`$INSTANCE_NAME`_common_ee_hal_structs.h"
...
#ifdef __CORTEX_MX__
#include "`$INSTANCE_NAME`_cortex_mx_ee_nvic.h"
#include "`$INSTANCE_NAME`_cortex_mx_ee_systick.h"
#endif
